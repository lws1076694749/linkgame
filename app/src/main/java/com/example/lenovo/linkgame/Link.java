package com.example.lenovo.linkgame;
...
import com.example.lenovo.linkgame.object.LinkInfo;
import com.example.lenovo.linkgame.view.GameView;
import com.example.lenovo.linkgame.view.Piece;
...
public class Link extends Activity {
    ...
    private Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0x123:
                    timeTextView.setText("剩余时间： " + gameTime + "s");
                    gameTime--;
                    // 时间小于0, 游戏失败
                    if (gameTime < 0) {
                        stopTimer();
